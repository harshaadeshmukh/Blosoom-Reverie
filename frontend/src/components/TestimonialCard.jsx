...
export default function TestimonialCard({ quote, name, city, image_url, rating = 5, index = 0 }) {
  ...
  return (
    <div
      ref={cardRef}
      className={`bg-charcoal-mid p-6 md:p-8 rounded-2xl group transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_12px_24px_rgba(26,15,15,0.4)] flex flex-col gap-5 md:gap-6 border border-white/5
