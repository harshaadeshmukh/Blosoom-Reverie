                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3 text-sm text-text-dim">
                        ...
                        <a href={`mailto:${order.email}`} className="whitespace-nowrap hover:text-charcoal hover:underline transition-colors">{order.email}</a>
                      </div>
                      <div className="flex items-center gap-3 text-sm text-text-dim">
                        ...
                        <a href={order.contact ? `https://wa.me/${order.contact.replace(/\D/g, '')}` : '#'} target="_blank" rel="noopener noreferrer" className="whitespace-nowrap hover:text-charcoal hover:underline transition-colors">{order.contact}</a>
                      </div>
                      <div className="flex items-center gap-3 text-sm text-text-dim">
